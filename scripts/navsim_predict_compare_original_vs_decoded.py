...
def main():
    default_predict = "/e2e-data/evad-tech-vla/lujinghui/ms-swift/outputs/roadwork/qwen3_vl_latent_cot_stage2_vis4_txt2_fixbug_512_bs64_with_viscondition/v0-20260324-031631/checkpoint-1008/infer_results_prefill_explain/_splits_3803491/predict_0.json"
    ...
    parser.add_argument(
        "--out_dir",
        type=str,
        default=os.path.join(_MS_SWIFT_ROOT, "demo_data", "roadwork_stage2_compare_512_viscond"),
    )
