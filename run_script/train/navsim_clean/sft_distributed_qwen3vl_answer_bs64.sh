...
DATASET_PATH="${SCRIPT_DIR}/demo_data/navsim/navsim_answer_demo100.json"
...
swift sft \
    ...
    --output_dir "${SCRIPT_DIR}/outputs/navsim/qwen3vl_8b_stage0_answer" \
    --deepspeed zero3 \
  2>&1 | tee "${SCRIPT_DIR}/logs/navsim/qwen3vl_8b_stage0_answer.log"
