...
swift sft \
    ...
    --output_dir "${SCRIPT_DIR}/outputs/navsim/qwen3_vl_latent_cot_stage1_vis4_txt2_fixbug_512_bs64_txt01" \
    --gradient_checkpointing true \
    --deepspeed zero2 \
  2>&1 | tee "${SCRIPT_DIR}/logs/navsim/qwen3_vl_latent_cot_stage1_vis4_txt2_fixbug_512_bs64_txt01.log"