...
# ---------- Model paths ----------
MODEL_PATH="/e2e-data/evad-tech-vla/lujinghui/ms-swift/outputs/navsim/qwen3_vl_latent_cot_stage1_vis4_txt2_fixbug_256/v0-20260319-111143/checkpoint-1614" ## previous stage2 model path
...
export LATENT_COT_EXPLAIN_LOSS_WEIGHT=0.0
...
swift sft \
    ...
    --output_dir "${SCRIPT_DIR}/outputs/navsim/qwen3_vl_latent_cot_stage2_vis4_txt2_fixbug_256_bs64_notext" \
    --gradient_checkpointing true \
    --deepspeed zero2 \
  2>&1 | tee "${SCRIPT_DIR}/logs/navsim/qwen3_vl_latent_cot_stage2_vis4_txt2_fixbug_256_bs64_notext.log"