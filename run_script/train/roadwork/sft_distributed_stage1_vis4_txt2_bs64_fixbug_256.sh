...
DATASET_PATH="/e2e-data/evad-tech-vla/lujinghui/ms-swift/data/roadwork/roadwork_data_256_2frames.jsonl"
VAL_DATASET_PATH="/e2e-data/evad-tech-vla/lujinghui/ms-swift/data/roadwork/roadwork_data_256_2frames_100.jsonl"
...
export LATENT_COT_LATENT_CE_LOSS=true ## latent token compute ce loss
export LATENT_COT_LATENT_USE_ALL_SUBTOKENS=true ## use all subtokens for latent ce loss
export LATENT_COT_USE_ORIGINAL_VOCAB=true ## use original vocab
...
swift sft \
    ...
    --output_dir "${SCRIPT_DIR}/outputs/roadwork/qwen3_vl_latent_cot_stage1_vis4_txt2_fixbug_256_2frames" \
    --gradient_checkpointing true \
    --deepspeed zero3 \
  2>&1 | tee "${SCRIPT_DIR}/logs/roadwork/qwen3_vl_latent_cot_stage1_vis4_txt2_fixbug_256_2frames.log"