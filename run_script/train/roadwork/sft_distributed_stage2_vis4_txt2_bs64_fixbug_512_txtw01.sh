...
# ---------- Model paths ----------
MODEL_PATH="/e2e-data/evad-tech-vla/lujinghui/ms-swift/outputs/roadwork/qwen3_vl_latent_cot_stage1_vis4_txt2_fixbug_512_bs64_txtw01/v0-20260324-082322/checkpoint-252" ## previous stage1 model path
...
swift sft \
    ...
    --output_dir "${SCRIPT_DIR}/outputs/roadwork/qwen3_vl_latent_cot_stage2_vis4_txt2_fixbug_512_bs64_txtw01" \
    --gradient_checkpointing true \
    --deepspeed zero2 \
  2>&1 | tee "${SCRIPT_DIR}/logs/roadwork/qwen3_vl_latent_cot_stage2_vis4_txt2_fixbug_512_bs64_txtw01.log"