...
# ---------- Model paths ----------
MODEL_PATH="/e2e-data/evad-tech-vla/lujinghui/ms-swift/outputs/roadwork/qwen3_vl_latent_cot_stage1_vis4_txt2_fixbug_512_2frames/v0-20260322-041712/checkpoint-252" ## previous stage1 model path
...
swift sft \
    ...
    --output_dir "${SCRIPT_DIR}/outputs/roadwork/qwen3_vl_latent_cot_stage2_vis4_txt2_fixbug_vit_1e-5_512_2frames" \
    --gradient_checkpointing true \
    --deepspeed zero3 \
  2>&1 | tee "${SCRIPT_DIR}/logs/roadwork/qwen3_vl_latent_cot_stage2_vis4_txt2_fixbug_vit_1e-5_512_2frames.log"