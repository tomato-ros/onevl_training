...
DATASET_PATH="${SCRIPT_DIR}/data/navsim_latent_cot_full_latent_4.jsonl"
...
swift sft \
    ...
    --output_dir "${SCRIPT_DIR}/outputs/navsim/qwen3vl_stage0_latent_4" \
    --deepspeed zero3 \
  2>&1 | tee "${SCRIPT_DIR}/logs/navsim/qwen3vl_stage0_latent_4.log"
