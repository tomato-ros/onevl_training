...
swift sft \
    ...
    --output_dir "${SCRIPT_DIR}/outputs/navsim/qwen3_vl_latent_cot_stage2_novision_subtokens_weight1" \
    --gradient_checkpointing true \
    --deepspeed zero3 \
  2>&1 | tee "${SCRIPT_DIR}/logs/navsim/qwen3_vl_latent_cot_stage2_novision_subtokens_weight1.log"
