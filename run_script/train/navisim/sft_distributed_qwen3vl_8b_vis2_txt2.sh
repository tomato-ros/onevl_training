...
DATASET_PATH="${SCRIPT_DIR}/data/navsim_vis2_text2.jsonl"
...
swift sft \
    ...
    --output_dir "${SCRIPT_DIR}/outputs/navsim/qwen3vl_8b_stage0_vis2_txt2" \
    --deepspeed zero3 \
  2>&1 | tee "${SCRIPT_DIR}/logs/navsim/qwen3vl_8b_stage0_vis2_txt2.log"
