...
# ---------- Model paths ----------
MODEL_PATH="/e2e-data/evad-tech-vla/huangzhijian/projects/ms-swift/outputs/baseline_answer_latenttoken_qwen_allfinetune/v2-20260313-030404/checkpoint-3228"
...
export LATENT_COT_VISUAL_AUX_VISUAL_CONDITION=false
...
swift sft \
    ...
    --output_dir "${SCRIPT_DIR}/outputs/navsim/qwen3_vl_latent_cot_stage1" \
    --gradient_checkpointing true \
    --deepspeed zero3 \
  2>&1 | tee "${SCRIPT_DIR}/logs/navsim/qwen3_vl_latent_cot_stage1.log"
