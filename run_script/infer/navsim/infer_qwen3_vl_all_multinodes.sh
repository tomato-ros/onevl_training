...
OUTPUT_PATH=/e2e-data/evad-tech-vla/lujinghui/ms-swift/outputs/navsim/qwen3_vl_latent_cot_stage1/v0-20260313-124424/checkpoint-1000/infer_results/qwen3_vl_infer_onevl_merged.json
OUTPUT_PATH_EVAL=/e2e-data/evad-tech-vla/lujinghui/ms-swift/outputs/navsim/qwen3_vl_latent_cot_stage1/v0-20260313-124424/checkpoint-1000/infer_results/qwen3_vl_infer_onevl_merged_eval.json
