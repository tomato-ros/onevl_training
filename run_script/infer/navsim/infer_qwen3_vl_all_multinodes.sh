...
MODEL_PATH=outputs/navsim/qwen3vl_stage0_vis4_txt2_2nodes/v0-20260316-105700/checkpoint-3228
...
AUX_MODEL_PATH=${AUX_MODEL_PATH:-"/qwen3vl/Qwen3-VL-4B-Instruct-latent"}
...
VISUAL_AUX_MODEL_PATH=${VISUAL_AUX_MODEL_PATH:-"/qwen3_vl_visual_aux_decoder_ad/checkpoints/global_step_13040/hf_ckpt"}
