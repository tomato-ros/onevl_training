...
OUTPUT_PATH=/e2e-data/evad-tech-vla/lujinghui/ms-swift/outputs/navsim/qwen3_vl_latent_cot_stage2_novision/v4-20260313-170856/checkpoint-500/infer_results_prefill/qwen3_vl_infer_onevl_merged.json
OUTPUT_PATH_EVAL=/e2e-data/evad-tech-vla/lujinghui/ms-swift/outputs/navsim/qwen3_vl_latent_cot_stage2_novision/v4-20260313-170856/checkpoint-500/infer_results_prefill/qwen3_vl_infer_onevl_merged_eval.json
