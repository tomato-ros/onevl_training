...
# ============================================================
# Latent CoT single-GPU training / debug script
...
# Must freeze aux decoders on single GPU to fit in memory (~67 GiB peak)
...
CUDA_VISIBLE_DEVICES=0 python swift/cli/sft.py \
    ...
    --output_dir "${SCRIPT_DIR}/outputs/qwen3_vl_latent_cot_sft" \
    --gradient_checkpointing true \
    --freeze_parameters _latent_cot_aux_decoder _latent_cot_visual_aux_decoder \
  2>&1 | tee "${SCRIPT_DIR}/logs/qwen3_vl_latent_cot_sft.log"
